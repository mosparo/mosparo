...
final class UnicodeBlockRuleType extends AbstractRuleType
{
    ...
    protected string $name = 'rules.fieldRule.type.unicodeBlock.title';
    protected string $description = 'rules.fieldRule.type.unicodeBlock.shortIntro';
    protected string $icon = 'ti ti-language';
    protected array $subtypes = [
        [
            'key' => 'block',
            'name' => 'rules.fieldRule.type.unicodeBlock.block.title',
        ],
    ];
    protected string $testerClass = UnicodeBlockRuleTester::class;
    protected array $targetFieldKeys = ['formData.'];
    protected string $helpTemplate = 'project_related/rules/field_rule/type/help/unicodeBlock.html.twig';
