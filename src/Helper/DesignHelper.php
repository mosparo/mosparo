...
class DesignHelper
{
    ...
    protected static array $cssVariableNames = [
        ...
        '--mosparo-circle-radius' => ['key' => 'checkboxRadius', 'type' => 'number'],
        '--mosparo-circle-border-width' => ['key' => 'checkboxBorderWidth', 'type' => 'number'],
