...
class DesignSettingsFormType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ...
            ->add('colorFailureTextError', TextType::class, ['label' => 'settings.design.form.color.textError', 'required' => false, 'attr' => ['class' => 'colorpicker', 'data-variable' => '--mosparo-failure-text-error-color']])
