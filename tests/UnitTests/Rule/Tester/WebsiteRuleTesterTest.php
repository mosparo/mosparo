...
use Mosparo\Rules\FieldRule\Tester\WebsiteRuleTester;
...
class WebsiteRuleTesterTest extends TestCaseWithItems
{
    public function testValidateDataWebsite()
    {
        ...
        $result = $ruleTester->validateData('test', 'http://example.com/test/test.html', $ruleItemStub);
    ...
    public function testValidateDataNothingFound()
    {
        ...
        $ruleTester = new WebsiteRuleTester();
        $result = $ruleTester->validateData('test', '//test.com/test/test.html', $ruleItemStub);
