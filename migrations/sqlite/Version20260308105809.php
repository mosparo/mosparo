 ...
 */
final class Version20260308105809 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE day_statistic ADD COLUMN updated_at DATETIME DEFAULT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TEMPORARY TABLE __temp__day_statistic AS SELECT id, date, number_of_valid_submissions, number_of_spam_submissions, project_id FROM day_statistic');
        ...
        $this->addSql('INSERT INTO day_statistic (id, date, number_of_valid_submissions, number_of_spam_submissions, project_id) SELECT id, date, number_of_valid_submissions, number_of_spam_submissions, project_id FROM __temp__day_statistic');
