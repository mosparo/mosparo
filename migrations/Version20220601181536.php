 ...
 */
final class Version20220601181536 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE project ADD uuid CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', CHANGE private_key private_key TEXT COMMENT \'(Encrypted)\' NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE project DROP uuid, CHANGE private_key private_key TEXT NOT NULL COMMENT \'(Encrypted)\'');
