 ...
 */
final class Version20251012081502 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE rule_package ALTER source TYPE TEXT');
        $this->addSql('ALTER TABLE rule_package ALTER source DROP NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX ip_ipaddress_idx');
        $this->addSql('ALTER TABLE rule_package ALTER source TYPE TEXT');
        $this->addSql('ALTER TABLE rule_package ALTER source SET NOT NULL');
        $this->addSql('DROP INDEX l_validuntil_idx');
        $this->addSql('DROP INDEX cs_datetime_idx');
        $this->addSql('DROP INDEX p_publickey_idx');
        $this->addSql('DROP INDEX s_submittedat_idx');
        $this->addSql('DROP INDEX s_spam_idx');
        $this->addSql('DROP INDEX s_valid_idx');
        $this->addSql('DROP INDEX st_token_idx');
        $this->addSql('DROP INDEX st_createdat_idx');
        $this->addSql('DROP INDEX d_validuntil_idx');
    }
}
